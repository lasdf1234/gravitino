...
/** Represents an event triggered when disabling a user by Gravitino-assigned id fails. */
@DeveloperApi
public class DisableUserByIdFailureEvent extends UserFailureEvent {
  private final long userId;

  /**
   * Creates a new {@link DisableUserByIdFailureEvent}.
   *
   ...
   */
  public DisableUserByIdFailureEvent(
