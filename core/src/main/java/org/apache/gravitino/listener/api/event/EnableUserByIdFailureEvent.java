...
/** Represents an event triggered when enabling a user by Gravitino-assigned id fails. */
@DeveloperApi
public class EnableUserByIdFailureEvent extends UserFailureEvent {
  private final long userId;

  /**
   * Creates a new {@link EnableUserByIdFailureEvent}.
   *
   ...
   */
  public EnableUserByIdFailureEvent(
